...
class WelcomeView extends StatelessWidget {
  ...
  Text buildTextAppBar(BuildContext context) {
    return Text(
      _appBarTitle,
      style: Theme.of(context).primaryTextTheme.titleLarge!.copyWith(color: Theme.of(context).colorScheme.onPrimary),
    );
  }
  ...
  Container buildContainerBottom() => Container(color: Colors.blue);
}